...
if(in_array("CONTENT", $arSetting["HOME_PAGE"]["VALUE"])):?>
	...
	<p class="TextP">Интеллектуальная система поиска и удобный интуитивный каталог позволит Вам найти то что нужно быстро и без особого труда. Преимущество нашего интернет-гипермаркета - понятная и простая работа. Для того чтобы найти нужный Вам товар и осуществить заказ достаточно нескольких минут. Вы можете выбрать удобный для Вас вариант оплаты и доставки. Все это позволяет максимально эффективно использовать Ваше время.
