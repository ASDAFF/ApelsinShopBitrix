...
$MESS["CATALOG_ELEMENT_BOC"] = "Быстрый заказ";
$MESS["CATALOG_ELEMENT_BOC_SHORT"] = "Быстрый заказ";
...
$MESS["CATALOG_ELEMENT_PROPERTIES_INFO_TEXT"] = "Информация о товаре, представленном на сайте, не является публичной офертой. Характеристики, комплект поставки и внешний вид товара могут отличаться от указанных или могут быть изменены производителем без отображения в каталоге магазина АПЕЛЬСИН. Условия приобретения товара требуют согласования с менеджером магазина. Предложение действительно с момента согласования его с менеджером Интернет-магазина.";
?>