										...
										<div class="catalog-item-info">
											...
											<div class="buy_more">
												<div class="add2basket_block">
													<?if($arItem["CAN_BUY"]):
														if($arItem["PRICE_DISCOUNT_VALUE"] <= 0):?>
															<a class="btn_buy apuo" id="ask_price_anch_set_<?=$arItem['ID']?>" href="javascript:void(0)" rel="nofollow"><i class="fa fa-comment-o"></i><span class="full"><?=GetMessage("CATALOG_SET_ASK_PRICE_FULL")?></span><span class="short"><?=GetMessage("CATALOG_SET_ASK_PRICE_SHORT")?></span></a>
															<?$APPLICATION->IncludeComponent("altop:ask.price", "",
																Array(
																	"ELEMENT_ID" => "set_".$arItem["ID"],		
														...
														<a class="btn_buy apuo" id="order_anch_set_<?=$arItem['ID']?>" href="javascript:void(0)" rel="nofollow"><i class="fa fa-clock-o"></i><span><?=GetMessage("CATALOG_SET_UNDER_ORDER")?></span></a>
