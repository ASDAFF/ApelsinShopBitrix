...
$MESS["AUTH_REQ_INFO"] = "Для корректной привязки дисконтной карты указывается Имя и Фамилия держателя карты.";
...
$MESS["REGISTER_FIELD_PASSWORD"] = "Пароль (мин. 6 символа)";
...
$MESS["REGISTER_EMAIL_WILL_BE_SENT"] = "На указанный при регистрации e-mail придет запрос на подтверждение.";
