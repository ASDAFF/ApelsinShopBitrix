...
(function( $ ){
  $.fn.printPage = function(options) {
    ...
    var pluginOptions = {
      attr : "href",
      url : false,
      message: "Пожалуйста подождите.<br>Мы создаем ваш документ."
    };
